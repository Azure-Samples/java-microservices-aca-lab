...
1. As a first step, create an identity which can be used by the container app to connect to other Azure services. This identity will be used in the next lab, but it is already handy to have it in place. 
