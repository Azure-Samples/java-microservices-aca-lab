...
1. Wait for the provisioning to finish, now you can create the other microservices, **customers-service**, **vets-service** and **visits-service**.
   ...
   {: .note }
   > The script [../tools/create-apps.sh](https://github.com/Azure-Samples/java-microservices-aca-lab/blob/main/tools/create-apps.sh) include all the steps to create the target apps, and it creates the apps parallelly to save the lab execution time. Open the file for more details.
