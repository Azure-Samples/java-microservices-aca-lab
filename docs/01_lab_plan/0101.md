...
1. Navigate to the [src folder of the GitHub repo of this lab](https://github.com/Azure-Samples/java-microservices-aca-lab/tree/main/src) and review the README.md file.
