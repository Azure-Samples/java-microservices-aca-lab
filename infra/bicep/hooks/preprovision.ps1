...
Write-Host "Run 'az ad signed-in-user show --query id --output tsv' in a managed environment to get the user object id"
Write-Host "    2." -ForegroundColor Red -NoNewline;
Write-Host "Run '\$env:AAD_USER_ID=<aad-user-id>' in this environment"
exit 1
